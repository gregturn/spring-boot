...
class HypermediaTestRestTemplateTests {
	...
	@ImportAutoConfiguration({HypermediaAutoConfiguration.class, HypermediaTestAutoConfiguration.class,
			RestTemplateAutoConfiguration.class, HttpMessageConvertersAutoConfiguration.class})
